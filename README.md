...
Capital for Aicountly — a React single-page app built with Vite and TypeScript,
with a small PHP API alongside it. Both halves deploy to cPanel.

| Environment | App | API |
| --- | --- | --- |
| Production | https://capital.aicountly.com | https://capital.aicountly.com/api |
| Sandbox | https://capital.gh.aicountly.com | https://capital.gh.aicountly.com/api |
...
(`https://capital.gh.aicountly.com/api`) so the token exchange has somewhere to
