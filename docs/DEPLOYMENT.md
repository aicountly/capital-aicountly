...
| --- | --- | --- |
| `web/dist/` | `<remote root>/` | https://capital.aicountly.com |
| `server-php/` | `<remote root>/api/` | https://capital.aicountly.com/api |
...
`https://capital.aicountly.com/api/.env` unless Apache is told otherwise. `server-php`
