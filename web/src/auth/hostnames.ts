 ...
 * capital.aicountly.com and capital.gh.aicountly.com. This is the fallback for
 * hosts the pattern does not cover — localhost above all.
 */
export const PRODUCT_KEY = (import.meta.env.VITE_PRODUCT_KEY ?? 'capital').trim() || 'capital'
...
/**
 * `capital.aicountly.com` and `capital.gh.aicountly.com` both resolve to
 * `capital`, which is what the portal expects in authentication_jump.
 */
